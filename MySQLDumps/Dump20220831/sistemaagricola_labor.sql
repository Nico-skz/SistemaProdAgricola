...
CREATE TABLE `labor` (
  ...
  `nombrelabor` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  PRIMARY KEY (`idlabor`)
...
INSERT INTO `labor` VALUES (1,'Agricultor'),(2,'Administrador'),(3,'Gerente'),(4,'Transportista');
